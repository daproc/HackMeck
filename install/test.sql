...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 18. Jun 2017 um 15:49
...
INSERT INTO `color` (`id`, `cal_month`, `cal_beleg`, `form_back`, `cal_back`, `back`, `font`) VALUES
(1, '#ffff00', '#ff0000', '#ffff00', '#ffffff', '#ffffff', '#000000');
...
--
-- Daten für Tabelle `mail_text`
--

INSERT INTO `mail_text` (`id`, `best_text`, `buch_text`) VALUES
(1, 'Das ist ein Test', 'und noch ein Test');
...
INSERT INTO `settings` (`id`, `cal_typ`) VALUES
(1, 3);
