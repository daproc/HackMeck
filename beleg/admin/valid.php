...
'.$best_text.'</p>';
		...
		echo '<br><div class=mailform><form action="index.php?in=mail" method="post">';
		echo '<fieldset>';
		...
		echo '<label for="nachricht" class="create">Nachricht:</label><br><textarea name="nachricht" cols="100" rows="20">'.$nachricht.'</textarea><br>';
