...
if ($text == 2){
	$form[] = '<label for="text" class="create">Nachricht*: </label><textarea name="text" rows="10" cols="50" required></textarea>';
}elseif ($text == 1){
	$form[] = '<label for="text" class="create">Nachricht: </label><textarea name="text" rows="10" cols="50"></textarea>';
}
