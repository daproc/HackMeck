...
if (isset($_GET['name']) AND !empty($_GET['name']) AND !isset($_GET['objekt'])){
	...
	$preis = $_GET['preis'];
	$ins_obj = "INSERT INTO objekt (name, max_people, max_tier, price) VALUES (?, ?, ?, ?)";
	$stmt = mysqli_prepare ($db_link, $ins_obj);
	mysqli_stmt_bind_param ($stmt, 'siii', $name, $max_per, $max_tier, $preis);
...
echo ' &lt;iframe sandbox=&quot;allow-forms&quot; src=&quot;http://';
